...
static __init int sched_init_debug(void)
{
	...
	debugfs_create_u64("flush_claimslist_ns", 0644, debugfs_sched, &flush_claimslist_ns);
	debugfs_create_u64("stale_request_ns", 0644, debugfs_sched, &stale_request_ns);
	debugfs_create_u64("max_vruntime_unclaimed_ns", 0644, debugfs_sched, &max_vruntime_unclaimed_ns);
